...
def checkIkeScan ():
	...
	proccess = subprocess.Popen("%s --version" % FULLIKESCANPATH, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, encoding='utf8')
	proccess.wait()
...
def discovery (args, targets, vpns):
	...
	for target in targets:
		...
		standardoutput = process.stdout.readlines()
